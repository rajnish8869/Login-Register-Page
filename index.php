...
<div style="margin: auto;width: 60%;">
	...
	<button type="button" class="btn btn-primary btn-sm" id="register">Register</button> <button type="button" class="btn btn-danger btn-sm" id="login">Login</button>
	...
	<form id="login_form" name="form1" method="post" style="display:none;">
		...
		<input type="button" name="save" class="btn btn-danger" value="Login" id="butlogin">
	</form>
</div>
